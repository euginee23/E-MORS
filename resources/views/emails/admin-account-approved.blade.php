...
<head>
    ...
    <title>Account Verified — E-MORS</title>
    <style>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-title">Account Verified ✅</div>
                <div class="header-sub">You can now access your admin dashboard</div>
            </div>

            <div class="body">
                <p class="greeting">Hello, <strong>{{ $user->name }}</strong>,</p>
                <p class="message">
                    Good news — the Super Admin has reviewed and verified your submitted credentials.
                    Your admin account for <strong>{{ $user->market?->name }}</strong> is now active and
                    you can log in to manage your municipality's market operations.
                </p>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $user->market?->name ?? '—' }}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Verified On</span>
                        <span class="detail-value">{{ $user->verified_at?->format('F j, Y g:i A') }}</span>
                    </div>
                </div>
                ...
                <div class="security">
                    <strong>Note:</strong> If you did not expect this email or believe this account was created in error, please contact the Super Admin immediately.
                </div>
            </div>
