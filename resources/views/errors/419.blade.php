            ...
            <main class="flex-1 flex items-center justify-center px-4 py-16 sm:py-24">
                <div class="text-center max-w-lg mx-auto">
                    ...
                    <div class="relative inline-block mb-6">
                        <span class="text-[8rem] sm:text-[10rem] font-black leading-none text-orange-100 dark:text-zinc-800 select-none">419</span>
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-zinc-900 dark:text-white mb-3">Session Expired</h2>
                    <p class="text-zinc-500 dark:text-zinc-400 text-sm sm:text-base leading-relaxed mb-8">
                        Your session has expired due to inactivity. Please refresh the page or return to the previous page and try again.
                    </p>
