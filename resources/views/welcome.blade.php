...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-orange-50 dark:bg-zinc-950 min-h-screen">
        ...
        <div class="relative">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-20">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="relative">
                                <div class="w-12 h-12 bg-gradient-to-br from-orange-500 via-amber-500 to-yellow-500 rounded-2xl rotate-3 shadow-lg"></div>
                                <div class="absolute inset-0 w-12 h-12 bg-gradient-to-br from-orange-600 via-amber-600 to-yellow-600 rounded-2xl -rotate-3 flex items-center justify-center">
                    ...
                    <div class="grid lg:grid-cols-5 gap-12 items-center">
                        ...
                        <div class="lg:col-span-3 space-y-8">
                            <div class="inline-block">
                                <span class="px-4 py-2 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-sm font-bold rounded-full border border-orange-200 dark:border-orange-800">
                                    🏪 Operations Management System (OMS)
                                </span>
                            </div>

                            <h1 class="text-5xl lg:text-7xl font-black text-zinc-900 dark:text-white leading-[1.1]">
                                Modern
                                <span class="relative inline-block">
                                    ...
                                    <span class="absolute bottom-2 left-0 right-0 h-4 bg-orange-200 dark:bg-orange-900/50 -z-0 -rotate-1"></span>
                                </span>
                                <br>Management
                            </h1>

                            <p class="text-xl text-zinc-600 dark:text-zinc-400 max-w-xl leading-relaxed">
                            ...
                            <div class="flex flex-wrap gap-4 pt-4">
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="group inline-flex items-center gap-3 px-8 py-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold text-lg rounded-2xl transition-all hover:scale-105 shadow-xl">
                                        Start Free Trial
                                ...
                                @endif
                                <a href="#modules" class="inline-flex items-center gap-3 px-8 py-4 border-2 border-zinc-300 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 font-bold text-lg rounded-2xl transition-all hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400">
                        ...
                        <div class="lg:col-span-2 relative">
                            <div class="relative">
                                <!-- Main Card -->
                                <div class="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl p-8 border border-orange-100 dark:border-zinc-800">
                                    <!-- Market Map Preview -->
                                    <div class="mb-6">
                                        <div class="flex items-center justify-between mb-4">
                                            <h3 class="font-bold text-zinc-900 dark:text-white">Market Layout</h3>
                                            <span class="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-2 py-1 rounded-full font-medium">Live</span>
                                        </div>
                                        <!-- Stall Grid -->
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        <div class="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-3 text-center">
                                            <div class="text-2xl font-black text-orange-600 dark:text-orange-400">248</div>
                                            <div class="text-xs text-zinc-500 dark:text-zinc-400">Vendors</div>
                                        </div>
                                        <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-3 text-center">
                                            <div class="text-2xl font-black text-green-600 dark:text-green-400">92%</div>
                                            <div class="text-xs text-zinc-500 dark:text-zinc-400">Occupancy</div>
                                        </div>
                                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-center">
                                            <div class="text-2xl font-black text-blue-600 dark:text-blue-400">₱1.2M</div>
                                            <div class="text-xs text-zinc-500 dark:text-zinc-400">Revenue</div>
                                        </div>
                                    </div>
                                </div>

                                <!-- Floating Cards -->
                                <div class="absolute -top-4 -right-4 bg-white dark:bg-zinc-800 rounded-2xl shadow-lg p-4 border border-orange-100 dark:border-zinc-700 animate-bounce" style="animation-duration: 3s;">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-bold text-zinc-900 dark:text-white">Payment Received</div>
                                            <div class="text-xs text-zinc-500">Stall A-15 • ₱500</div>
                                        </div>
                                    </div>
                                </div>

                                <div class="absolute -bottom-4 -left-4 bg-white dark:bg-zinc-800 rounded-2xl shadow-lg p-4 border border-orange-100 dark:border-zinc-700">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-bold text-zinc-900 dark:text-white">New Vendor</div>
                                            <div class="text-xs text-zinc-500">Maria Santos registered</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="about" class="py-20 bg-white dark:bg-zinc-900">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center mb-16">
                        <h2 class="text-4xl font-black text-zinc-900 dark:text-white mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-red-50 dark:bg-red-900/10 rounded-3xl p-8 border border-red-100 dark:border-red-900/30">
                            <div class="w-14 h-14 bg-red-100 dark:bg-red-900/30 rounded-2xl flex items-center justify-center mb-6">
                                <svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                </svg>
                            </div>
                            <h3 class="text-2xl font-bold text-red-800 dark:text-red-300 mb-4">The Problem</h3>
                            <ul class="space-y-3 text-red-700 dark:text-red-300/80">
                        ...
                        <!-- Solution Card -->
                        <div class="bg-green-50 dark:bg-green-900/10 rounded-3xl p-8 border border-green-100 dark:border-green-900/30">
                            ...
                            <h3 class="text-2xl font-bold text-green-800 dark:text-green-300 mb-4">The Solution</h3>
                            <ul class="space-y-3 text-green-700 dark:text-green-300/80">
                                <li class="flex items-start gap-3">
            ...
            <section id="modules" class="py-20 bg-gradient-to-b from-orange-50 to-amber-50 dark:from-zinc-950 dark:to-zinc-900 overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-12">
                        <span class="inline-block px-4 py-1.5 bg-orange-200 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 text-sm font-bold rounded-full mb-4">
                            SYSTEM MODULES
                        </span>
                        <h2 class="text-4xl font-black text-zinc-900 dark:text-white">
                            Everything You Need
                        </h2>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 bg-gradient-to-br from-orange-500 to-amber-600 rounded-3xl p-8 text-white relative overflow-hidden group">
                            ...
                            <div class="relative">
                                ...
                                <h3 class="text-3xl font-bold mb-3">Vendor Management</h3>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">Registration</span>
                                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">Permits</span>
                                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">Renewals</span>
                                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">History</span>
                                </div>
                            </div>
                        </div>

                        <!-- Module 2 - Stall Allocation -->
                        <div class="bg-white dark:bg-zinc-800 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-700 group hover:border-orange-300 dark:hover:border-orange-700 transition-colors">
                            <div class="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                                </svg>
                            </div>
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-2">Stall Allocation</h3>
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-700 group hover:border-orange-300 dark:hover:border-orange-700 transition-colors">
                            <div class="w-14 h-14 bg-green-100 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                            </div>
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-2">Fee Collection</h3>
                            <p class="text-zinc-600 dark:text-zinc-400">
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-700 group hover:border-orange-300 dark:hover:border-orange-700 transition-colors">
                            <div class="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                            </div>
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-2">Reports & Analytics</h3>
                            <p class="text-zinc-600 dark:text-zinc-400">
                        ...
                        <!-- Module 5 - Wide Card -->
                        <div class="lg:col-span-2 bg-zinc-900 dark:bg-zinc-800 rounded-3xl p-8 text-white relative overflow-hidden">
                            <div class="grid md:grid-cols-2 gap-8 items-center">
                                <div>
                                    <div class="w-14 h-14 bg-amber-500/20 rounded-2xl flex items-center justify-center mb-5">
                                        <svg class="w-7 h-7 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                        </svg>
                                    </div>
                                    <h3 class="text-2xl font-bold mb-3">Security & Access Control</h3>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center gap-3 bg-white/5 rounded-xl p-3">
                                        ...
                                        <span class="text-sm">Collector Portal</span>
                                    </div>
                                    <div class="flex items-center gap-3 bg-white/5 rounded-xl p-3">
                                        <div class="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center">
                                            <svg class="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <span class="text-sm">Vendor Self-Service</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="benefits" class="py-20 bg-white dark:bg-zinc-900">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16">
                        <h2 class="text-4xl font-black text-zinc-900 dark:text-white mb-4">
                    ...
                    <div class="grid md:grid-cols-4 gap-8">
                        <div class="text-center group">
                            <div class="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-500 mb-3 group-hover:scale-110 transition-transform">
                                95%
                            </div>
                            <div class="text-zinc-600 dark:text-zinc-400 font-medium">Faster Registration</div>
                        </div>
                        <div class="text-center group">
                            <div class="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500 mb-3 group-hover:scale-110 transition-transform">
                                0%
                            </div>
                            <div class="text-zinc-600 dark:text-zinc-400 font-medium">Revenue Leakage</div>
                        </div>
                        <div class="text-center group">
                            <div class="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 mb-3 group-hover:scale-110 transition-transform">
                                100%
                            </div>
                            <div class="text-zinc-600 dark:text-zinc-400 font-medium">Digital Records</div>
                        </div>
                        <div class="text-center group">
                            <div class="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 mb-3 group-hover:scale-110 transition-transform">
                                24/7
                            </div>
                            <div class="text-zinc-600 dark:text-zinc-400 font-medium">System Access</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- CTA Section -->
            <section class="py-20 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-black dark:via-zinc-900 dark:to-black relative overflow-hidden">
                <div class="absolute inset-0">
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-500/20 rounded-full blur-3xl"></div>
                </div>
                <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="group inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold text-xl rounded-2xl transition-all shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105">
                                Get Started Free
                        ...
                        @endif
                        <a href="{{ route('login') }}" class="inline-flex items-center gap-3 px-10 py-5 border-2 border-zinc-700 text-white font-bold text-xl rounded-2xl transition-all hover:border-orange-500 hover:bg-orange-500/10">
                            Sign In
                        </a>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <footer class="bg-zinc-950 text-white py-16 px-4 sm:px-6 lg:px-8">
                <div class="max-w-7xl mx-auto">
                    <div class="grid md:grid-cols-4 gap-12 mb-12">
                        <div class="md:col-span-2">
                            ...
                            <p class="text-zinc-400 max-w-md leading-relaxed">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3 text-zinc-400">
                                ...
                                <li><a href="#modules" class="hover:text-orange-400 transition-colors">Modules</a></li>
                                <li><a href="#benefits" class="hover:text-orange-400 transition-colors">Benefits</a></li>
                            </ul>
                        </div>
                        
                        <div>
                            <h4 class="font-bold mb-4 text-lg">Account</h4>
                            <ul class="space-y-3 text-zinc-400">
        ...
        <button 
            id="scrollToTop"
            class="fixed bottom-8 right-8 w-14 h-14 bg-gradient-to-br from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-2xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300 flex items-center justify-center z-50 opacity-0 invisible translate-y-4 hover:-translate-y-0 hover:scale-105"
